...
(function() {
  ...
  canvasDataURL = function(path, obj, quality = 0.7, callback) {
    var img;
    img = new Image();
    img.src = path;
  ...
  $(function() {
    ...
    CDN_PREFIX = "http://qiniu-test.ryankiu.tech";
    file_lists = [];
    ...
    if (window.File && window.FileList && window.FileReader && window.Blob && window.Worker) {
        ...
        uploadFile = function(file) {
          ...
          reader.onload = function(evt) {
            ...
            worker.onmessage = function(event) {
              ...
              md5 = event.data;
              Qiniu_UploadUrl_https = "http://upload-na0.qiniup.com";
              if (window.location.protocol === "https:") {
                Qiniu_UploadUrl = Qiniu_UploadUrl_https;
              } else {
                Qiniu_UploadUrl = "http://upload-na0.qiniup.com";
              }
                ...
                Qiniu_upload = function(f, token, key) {
                  ...
                  xhr.onreadystatechange = function(response) {
                    ...
                    if (xhr.readyState === 4 && xhr.status === 200 && xhr.responseText !== "") {
                      ...
                      $(".inputbox").val("QINIUIMAGE//undefined_"+md5)
                      $('.sendbtn')[0].click()
      ...
      $("body").on("change", ".input_img", handleFileSelect);
      return $("body").on("click", ".blue", function(evt) {
